...
function About() {
  return (
    <section className='pt-10 pb-10 py-2 mt-5 w-screen'>
        ...
        <div className='text-center text-sm pr-2 leading-tight sm:w-fit'>
            <div>
                <p className=''>At <span className='text-teal-500 font-medium'>Marga</span> Smoothies, we're passionate about crafting smoothies that not only taste amazing but are made with the highest quality ingredients.</p>
                <p>Every smoothie we serve is blended with premium, hand-selected fruits to ensure a rich, natural flavor in every sip.
